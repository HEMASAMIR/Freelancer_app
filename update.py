...
file_path = 'c:/freelancer/lib/features/host/presentation/listing_management_screen.dart'

with open(file_path, 'r', encoding='utf-8') as f:
    content = f.read()

# 1. Replace _SettingsTab up to // TAB 4
settings_tab_new = """// ============================================================
// TAB 3 – SETTINGS
// ============================================================
...
pattern_settings = re.compile(r'// ============================================================\n// TAB 3 – SETTINGS\n// ============================================================.*?// ============================================================\n// TAB 4 – CONDITIONS \(Enhanced\)\n// ============================================================', re.DOTALL)
content = pattern_settings.sub(settings_tab_new + '// ============================================================\n// TAB 4 – CONDITIONS (Enhanced)\n// ============================================================', content)

# 2. Append _AmenitiesTab and _CancellationTab
amenities_and_cancellation = """
// ============================================================
// TAB 5 – AMENITIES
// ============================================================
...
pattern_bottom = re.compile(r'class _AmenitiesTab extends StatelessWidget \{.*?\}\s*\}', re.DOTALL)
content = pattern_bottom.sub(amenities_and_cancellation, content)
