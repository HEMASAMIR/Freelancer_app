...
//             value: sl<AuthCubit>(), // استخدمنا .value عشان ميموتش
...
//             providers: [
//               BlocProvider.value(value: sl<AuthCubit>()), // ضروري للدراور
...
//             providers: [
//               BlocProvider.value(value: sl<AuthCubit>()), // ضيفه هنا كمان
//               BlocProvider.value(value: sl<FavCubit>()..loadFavorites()),
      ...
      case AppRoutes.adminDashboard:
        return MaterialPageRoute(
          builder: (_) => MultiBlocProvider(
            ...
            child: const AdminOverviewScreen(), // ✅ الـ dashboard الحقيقي
          ),
        );

      case AppRoutes.adminOverview: // ✅ الجديد
        return MaterialPageRoute(
          builder: (_) => MultiBlocProvider(
            providers: [
              BlocProvider.value(value: sl<AuthCubit>()),
